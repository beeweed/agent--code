      ...
      <div className={classNames(styles.Chat, 'flex flex-col flex-grow h-full')}>
        {!chatStarted && (
          <div id="intro" className="mt-[26vh] max-w-chat mx-auto">
            <h1 className="text-5xl text-center font-bold text-bolt-elements-textPrimary mb-2">Where ideas begin</h1>
    ...
    return (
      ...
      >
        ...
        <PanelGroup direction="horizontal" className="w-full h-full">
          <Panel defaultSize={chatStarted ? 40 : 100} minSize={25} className="h-full">
            <div ref={scrollRef} className="overflow-y-auto w-full h-full">
              {chatPanel}
            </div>
          </Panel>
          {chatStarted && (
